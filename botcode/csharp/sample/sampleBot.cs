...
namespace sample
{
    ...
    public static readonly string LuisConfiguration = "YOUR_LUIS_SERVICE_NAME";
        ...
        private readonly IStatePropertyAccessor<sample.userState> _myuserStateAccessor;
        ...
        /// </summary>
        public sampleBot(BotServices services, UserState userState, ConversationState conversationState, ILoggerFactory loggerFactory)
        {
            ...
            _myuserStateAccessor = _userState.CreateProperty<sample.userState>(nameof(userState));
            ...
            Dialogs.Add(new MainDialog(_myuserStateAccessor, loggerFactory));
        }
