...
- Setup LUIS
    ...
    msbot clone services --name "sample" --luisAuthoringKey <LUIS-authoring-key> --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
    ```
- Start the bot
    ```bash
    npm start
